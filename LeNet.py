...
class History(keras.callbacks.Callback):
    ...
    def make_remark(self):
        ...
        wb.save('./excel/plot_data_LeNet.xlsx')
    ...
    def loss_plot(self, loss_type):
        ...
        plt.savefig('./image/train-acc.png')
        plt.show()
        plt.clf()
...
def lenet():
    model = Sequential()
    model.add(Convolution2D(32, (5, 5), strides=(1, 1), input_shape=(28, 28, 1), padding='valid', activation='relu', kernel_initializer='uniform'))
    model.add(MaxPooling2D(pool_size=(2, 2)))
    model.add(Convolution2D(64, (5, 5), strides=(1, 1), padding='valid', activation='relu', kernel_initializer='uniform'))
    model.add(MaxPooling2D(pool_size=(2, 2)))
    model.add(Flatten())

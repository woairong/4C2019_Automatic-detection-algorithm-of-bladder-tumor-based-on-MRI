...
class History(keras.callbacks.Callback):
    ...
    def make_remark(self):
        ...
        wb.save('./excel/plot_data_LeNet_Stating.xlsx')
    ...
    def loss_plot(self, loss_type):
        ...
        plt.savefig('./image/train-acc-loss_Stating.png')
        plt.show()
        plt.clf()
        ...
        if loss_type == 'epoch':
            ...
            plt.legend(loc="upper right")
            plt.savefig('./image/val_acc-loss_Stating.png')
            plt.show()
...
path = '../DATA/TrainingData_Stating/'
...
for train, test in K_fold.split(data, label):
    ...
    if round == fold:
        ...
        model.save('./model/LeNet_Stating.h5')

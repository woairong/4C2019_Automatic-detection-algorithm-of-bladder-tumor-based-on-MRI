...
class History(keras.callbacks.Callback):
    ...
    def make_remark(self):
        ...
        wb.save('./excel/plot_data_AlexNet.xlsx')
...
def alexnet():
    model = Sequential()
    model.add(Convolution2D(96, (11, 11), strides=(4, 4), input_shape=(227, 227, 1), padding='valid', activation='relu', kernel_initializer='uniform'))
